...
async function handleSubmit() {
  ...
  try {
    ...
    error.value = err.response?.data?.detail || "Nieprawidłowy email lub hasło."
  } finally {
    loading.value = false
  }
}
  ...
  <div class="flex-1 flex items-center justify-center py-16 px-4">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        <h1 class="text-3xl font-extrabold text-white mb-2">Zaloguj się</h1>
      ...
      <p class="text-center text-sm text-slate-500 mt-6">
        Nie masz konta?
        <NuxtLink to="/register" class="text-brand-green hover:brightness-110 font-medium transition-colors">
          Zarejestruj się
        </NuxtLink>
      </p>
    </div>
