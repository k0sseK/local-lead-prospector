def get_verification_email_html(verify_link: str) -> str:
...
<head>
    ...
    <title>Weryfikacja konta - znajdzfirmy.pl</title>
    <style>
                ...
                <table class=\"container\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"600\" style=\"background-color: #111a18; border: 1px solid rgba(17, 153, 142, 0.2); border-radius: 24px; overflow: hidden; box-shadow: 0 20px 50px rgba(0,0,0,0.5);\">
                    ...
                    <tr>
                        <td class=\"content\" style=\"padding: 40px 50px 50px 50px;\">
                            <h1 style=\"margin: 0 0 15px 0; font-size: 24px; font-weight: 700; color: #ffffff; text-align: center;\">Potwierdź adres e-mail</h1>
                            <p style=\"margin: 0 0 25px 0; font-size: 16px; line-height: 1.6; color: #94a3b8; text-align: center;\">
                                Dziękujemy za rejestrację. Kliknij przycisk poniżej, aby aktywować konto i odblokować możliwość logowania.
                            </p>

                            <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">
                                <tr>
                                    <td align=\"center\" style=\"padding: 10px 0 30px 0;\">
                                        <a href=\"{verify_link}\" style=\"display: inline-block; padding: 16px 36px; font-size: 16px; font-weight: 700; color: #0a0f0e; text-decoration: none; background: linear-gradient(to right, #38ef7d, #11998e); background-color: #38ef7d; border-radius: 50px; box-shadow: 0 4px 15px rgba(56, 239, 125, 0.3);\">
                                            Potwierdź e-mail
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <div style=\"padding-top: 30px; border-top: 1px solid rgba(148, 163, 184, 0.1);\">
                                <p style=\"margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #64748b; text-align: center;\">
                                    Bez aktywacji nie będzie możliwe logowanie do konta.<br>
                            ...
                            <p style=\"margin: 20px 0 0 0; font-size: 12px; line-height: 1.5; color: #475569; text-align: center;\">
                                ...
                                <a href=\"{verify_link}\" style=\"color: #11998e; text-decoration: none; word-break: break-all;\">{verify_link}</a>
                            </p>
                        </td>
                    </tr>
